...
class StreamResponseCollector:
    ...
    def __init__(self, platform: AgentPlatform = AgentPlatform.COMMON,
        ...
        self.callback: Optional[Callable[[ClosureContext, Dict[str, Any], MessageContext], Awaitable[None]]] = None
